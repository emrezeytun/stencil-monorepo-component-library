...
const BUILD = /* hello-world */ { hydratedSelectorName: "hydrated"};
...
const HelloWorld$1 = /*@__PURE__*/ proxyCustomElement(class HelloWorld extends H {
    constructor() {
        super();
        this.__registerHost();
        this.__attachShadow();
...
export { HelloWorld, setNonce as a, setPlatformOptions as b, defineCustomElement, getAssetPath as g, render as r, setAssetPath as s };
