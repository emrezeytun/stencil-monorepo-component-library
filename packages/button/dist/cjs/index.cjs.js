...
var index = require('./index-CQZguWYK.js');
...
const Button = class {
    ...
    render() {
        return (index.h("button", { key: '1b1e7119b81dfef7652a86b8c5ec70dd6d65412f', class: `button button--${this.variant} button--${this.size} ${this.disabled ? 'button--disabled' : ''}`, disabled: this.disabled, type: this.type, onClick: this.handleClick }, index.h("slot", { key: 'ed9c5fd67306120e2dcc0dd3b4a05af3ab92b689' })));
    }
};
